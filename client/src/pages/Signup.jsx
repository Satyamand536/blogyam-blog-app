            ...
            <div className="max-w-md w-full glass-card p-10 rounded-2xl relative z-10 transition-colors duration-500">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="relative group">
                        <HiUser className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 dark:text-purple-300 transition-colors group-focus-within:text-purple-600 dark:group-focus-within:text-purple-400" size={20} />
                        <input
                            type="text"
                            required
                            value={name}
